...
if(mesafe>=10) digitalWrite(2,0); else digitalWrite(2,1);
if(mesafe>=20) digitalWrite(3,0); else digitalWrite(3,1);
if(mesafe>=30) digitalWrite(4,0); else digitalWrite(4,1);
